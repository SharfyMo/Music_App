...
import 'package:music_my/models/song_model.dart';
import 'package:music_my/widgets/widgets.dart';
...
class _SongScreen2State extends State<SongScreen2> {
  ...
  Song song = Get.arguments ?? Song.hafez[0] ?? Song.alset[0] ?? Song.kazem[0];
